...
public class UdpClientTwoClients : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        serverEP = new IPEndPoint(IPAddress.Parse("10.57.1.121"), 5001);
    ...
    void Update()
    {
        // Movimento local (vertical)
        float v = Input.GetAxis("Vertical");
        localCube.transform.Translate(new Vector3(0, v, 0) * Time.deltaTime * 8);
        ...
        if( ! remotePos.Equals(Vector3.zero ))
